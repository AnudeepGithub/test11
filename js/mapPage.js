...
//function to create the bottom panel for groups with their particular images and click events
function CreateBottomHeaders(arrSubjectGroups, groupdata, token, selectedLayer, bottomOffset) {
    ...
    for (var col in arrSubjectGroups) {
        ...
        /*This function will trigger when you click on the layer images located at the bottom panel*/
        ...
        //calculations for more button functionality,this more button will created when more number of groups are present.
...
//function to back to the home page with the animation effects
function BackToPods() {
    dojo.byId("divServiceDetails").style.display = "none";
    newLeft = 0;
...
//function to hide Information container
...
//function to show bookmark container with wipe In animation
...
//function to show customize(more) container
...
//function to create the list with their stored extent's of bookmarks through local storage
...
//function to show locate(address) container
...
//function to get current map Extent
...
//function to open Email client with the shared link
...
//function to create the metric pods for related groups
/*This function is used to create and style the metric pods like coloring and indicating the arrow according to their group webmap statistics 
with their click events in the carousel*/
function CreateGroupPods(webInfo, groupdata, token, statsData) {
    ...
    for (var p in webInfo) {
        ...
        /*This function will trigger when you click on the metric pod, It will change the particular basemap and layers and statistical informatio0n*/
            if (!((dojo.hasClass("div" + this.getAttribute("layer") + "Pod", "divPodRedSelected")) || (dojo.hasClass("div" + this.getAttribute("layer") + "Pod", "divPodGreenSelected")) || (dojo.hasClass("div" + this.getAttribute("layer") + "Pod", "divPodGraySelected")))) {
                ...
                /*Highlighting the pod depending on its pod color*/
...
//function to create neutral pod with their particular styles
...
//function to hide graph container
...
//function to create the data according to their info pods in the configuration file format
...
//function to create the chart according to their metric pods info data and styling the container
...
//function to populate chart for the metric pod
