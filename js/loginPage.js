...
/*This function will call when the DOM elements are ready*/
function Init() {
...
/*This function is used to signing in and sign out the user */
...
/*This function is used to find the group by its groupId,After getting the response,grouped the webmaps by using their particular tags and
created the info pods for the groups in the configuration file order*/
    ...
    portal.queryItems(params).then(function (groupdata) {
        ...
        esri.request({
            ...
            load: function (groupdata) {
                ...
                //made the groups in to configuration file order
                var orderedLayer = [];
...
/*This function is used to identify which group has the key indicators and to fetch the indicator data*/
